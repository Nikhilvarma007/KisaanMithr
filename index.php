        ...
        <div class="misc-wrapper">
            <div class="misc-content">
                <div class="container">
                    ...
                    <input id="exampleuser1" name="email" type="text" placeholder="Email" class="un" required="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="group-icon">
                    <input id="exampleInputPassword1" name="password" type="password" placeholder="Password"  class="un">
                                    ...
                                    <a href="stu_reg.php"> <label   class="forgot">Register </label></a><br> 
                                    <a href="forgot_P.php"><label class="forgot">Forgot Password</label></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <a href="formpage.html"><label class="forgot">Contact us</label></a>
