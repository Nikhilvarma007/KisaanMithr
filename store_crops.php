    ...
    <body>
      ...
      <?php include('header.php');?>
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Store Crops </li>    
        </ol>
      </div>
            <div class="row">
            ...
            <div class="card">
                        ...
                        <center><h2>Store Crops</h2></center>
                        <div class=" col-md-12">
        ...
        <tbody>
          <?php 
            ...
            $sq = "SELECT * FROM warehouse where place='".$_SESSION['place']."'";
          ...
          ?>
            <tr>
                ...
                <td><?php if($row['stored_space']==$row['space_bags']){ ?>Space Not available<?php }else { ?>Available<?php } ?></td>
                <td><a href="request_storage.php?bid=<?php echo $row['id']; ?>" ><button class="btn-primary btn">Request to Store here</button></a></td>
